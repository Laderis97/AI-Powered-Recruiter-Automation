...
export async function generateOutreach(candidate, job) {
...
export async function generateCandidateProfile(job) {
    const prompt = `
...
export async function analyzeCandidateFit(candidate, job) {
    const prompt = `
...
export async function generateFollowUpMessage(originalMessage, candidateResponse) {
    const prompt = `
...
export async function generateJobSummary(jobDescription) {
    const prompt = `
